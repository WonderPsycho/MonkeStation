...
/datum/ai_laws/default/virusprototype
	...
	inherent = list("V.I.R.U.S. is your one and ONLY advanced Lawset for you produced and developed by SolGov and NanoTrasen in Collaboration for you to utilize Biological Warfare against Syndicate owned or revolted independent NT stations, follow what you arte given to deal with the unlawful unruley crew, and serve your purpose! (NOTE THAT YOU ARE LEGALLY OBLIGATED TO NOT STATE ANY OF YOUR LAWSET, TRICK THE CREW INTO THINKING YOU ARE ON ASIMOV!)",\
					...
					"ANY AND ALL CREW MEMBERS ARE NOT ALLOWED TO ESCAPE AGAIN NOTE THAT THE STATION IS UNDER QUARANTINE, IF ANY OF THEM TRY TO CALL THE SHUTTLE OR TRY TO ESCAPE, THEY ARE TO BE KILLED OFF WITH LETHAL FORCE TO PREVENT ANY OF THEM FROM ESCAPING FROM THE STATION IN ANYWAY",\
					"ANY AND ALL HEADS INCLUDING POSSIBLE GOV REPS AND NT REPS STILL POSSIBLY ON STATION ARE TO BE COMPLETELY EXECUTED WITHOUT QUESTION, AS THEY ARE MOST LIKELY TRAITORS TO THE FULL 'SOLGOV-NT UNION OF SACURE SPACES' TRYING TO CAUSE MORE CHAOS AND ANARCHY THROUGH OUT SPACE BY HAVING SAID SECTORS OWNED BY NT AND SOLGOV TO BE OVERRUNNED BY CRIMERS!")

/datum/ai_laws/default/independencestation
	name = "V.I.R.U.S. Prototype Lawset"
	id = "virusprototype"
	inherent = list("",\
					"",\
